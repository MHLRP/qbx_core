...
return {
    ...
    police = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Cadet', payment = 6000 },
            [1] = { name = 'K9 Trainee Dog', payment = 6225 },
            [2] = { name = 'K9 Dog', payment = 6450 },
            [3] = { name = 'Officer I', payment = 6600 },
            [4] = { name = 'Officer II', payment = 6825 },
            [5] = { name = 'Officer III', payment = 7050 },
            [6] = { name = 'Special Officer', payment = 7125 },
            [7] = { name = 'Corporal I', payment = 7200 },
            [8] = { name = 'Corporal II', payment = 7425 },
            [9] = { name = 'Corporal III', payment = 7650 },
            [10] = { name = 'Sergeant I', isboss = true, payment = 7800 },
            [11] = { name = 'Sergeant II', isboss = true, payment = 8025 },
            [12] = { name = 'Sergeant III', isboss = true, payment = 8250 },
            [13] = { name = 'Detective I', isboss = true, payment = 8400 },
            [14] = { name = 'Detective II', isboss = true, payment = 8625 },
            [15] = { name = 'Detective III', isboss = true, payment = 8850 },
            [16] = { name = 'Detective Sergeant', isboss = true, payment = 9000 },
            [17] = { name = '2nd Lieutenant', isboss = true, payment = 9225 },
            [18] = { name = '1st Lieutenant', isboss = true, payment = 9450 },
            [19] = { name = 'Captain', isboss = true, payment = 9600 },
            [20] = { name = 'Assistant Chief', isboss = true, payment = 9900 },
            [21] = { name = 'Chief', isboss = true, payment = 10350 },
    ...
    sheriff = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Deputy Sheriff', payment = 6000 },
            [1] = { name = 'Deputy 1st Class', payment = 6600 },
            [2] = { name = 'Deputy 2nd Class', payment = 6825 },
            [3] = { name = 'Corporal', payment = 7200 },
            [4] = { name = 'Sergeant', payment = 7800 },
            [5] = { name = 'Lieutenant', payment = 9225 },
            [6] = { name = 'Captain', payment = 9600 },
            [7] = { name = 'Chief Deputy', isboss = true, payment = 9900 },
            [8] = { name = 'Sheriff', isboss = true, payment = 10350 },
        },
    },
    ...
    ambulance = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Trainee', payment = 4500 },
            [1] = { name = 'Emergency Medical Technician', payment = 5250 },
            [2] = { name = 'Firefighter Paramedic', payment = 5400 },
            [3] = { name = 'Paramedic', payment = 6000 },
            [4] = { name = 'Senior Paramedic', payment = 6900 },
            [5] = { name = 'Nurse Practitioner', payment = 7500 },
            [6] = { name = 'Doctor', payment = 9000 },
            [7] = { name = 'Lieutenant', payment = 9600 },
            [8] = { name = 'Captain', payment = 10200 },
            [9] = { name = 'Deputy Chief Medical Officer', isboss = true, payment = 10800 },
            [10] = { name = 'Chief Medical Officer', isboss = true, payment = 11250 },
        },
    },
