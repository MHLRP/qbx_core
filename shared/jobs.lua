...
return {
    ...
    lawyer = { label = 'Law Firm', defaultDuty = true, offDutyPay = false, grades = { [0] = { name = 'Associate', payment = 600 } } },
    trucker = { label = 'Trucker', defaultDuty = true, offDutyPay = false, grades = { [0] = { name = 'Driver', payment = 50 } } },
    onlytoes = { label = 'OnlyToes', defaultDuty = true, offDutyPay = false, grades = { [0] = { name = 'Driver', payment = 50 } } },
    pilot = { label = 'Pilot', defaultDuty = true, offDutyPay = false, grades = { [0] = { name = 'Pilot', payment = 50 } } },
    lifeguard = { label = 'Lifeguard', defaultDuty = true, offDutyPay = false, grades = { [0] = { name = 'Lifeguard', payment = 200 } } },
    ...
    cargo = { label = 'Cargo Delivery', defaultDuty = true, offDutyPay = false, grades = { [0] = { name = 'Driver', payment = 50 } } },
    ...
    police = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Cadet', payment = 1800 },
            [1] = { name = 'K9 Trainee Dog', payment = 1875 },
            [2] = { name = 'K9 Dog', payment = 1925 },
            [3] = { name = 'Officer I', payment = 1975 },
            [4] = { name = 'Officer II', payment = 2050 },
            [5] = { name = 'Officer III', payment = 2125 },
            [6] = { name = 'Special Officer', payment = 2150 },
            [7] = { name = 'Corporal I', payment = 2150 },
            [8] = { name = 'Corporal II', payment = 2225 },
            [9] = { name = 'Corporal III', payment = 2300 },
            [10] = { name = 'Sergeant I', isboss = true, payment = 2350 },
            [11] = { name = 'Sergeant II', isboss = true, payment = 2400 },
            [12] = { name = 'Sergeant III', isboss = true, payment = 2475 },
            [13] = { name = 'Detective I', isboss = true, payment = 2525 },
            [14] = { name = 'Detective II', isboss = true, payment = 2600 },
            [15] = { name = 'Detective III', isboss = true, payment = 2650 },
            [16] = { name = 'Detective Sergeant', isboss = true, payment = 2700 },
            [17] = { name = '2nd Lieutenant', isboss = true, payment = 2775 },
            [18] = { name = '1st Lieutenant', isboss = true, payment = 2825 },
            [19] = { name = 'Captain', isboss = true, payment = 2875 },
            [20] = { name = 'Assistant Chief', isboss = true, payment = 2975 },
            [21] = { name = 'Chief', isboss = true, payment = 3100 },
    ...
    sheriff = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Deputy Sheriff', payment = 1800 },
            [1] = { name = 'Deputy 1st Class', payment = 1975 },
            [2] = { name = 'Deputy 2nd Class', payment = 2050 },
            [3] = { name = 'Corporal', payment = 2150 },
            [4] = { name = 'Sergeant', payment = 2350 },
            [5] = { name = 'Lieutenant', payment = 2775 },
            [6] = { name = 'Captain', payment = 2875 },
            [7] = { name = 'Chief Deputy', isboss = true, payment = 2975 },
            [8] = { name = 'Sheriff', isboss = true, payment = 3100 },
        },
    },
    ...
    ghost = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Specter', payment = 2500 },
            [1] = { name = 'Reaper', payment = 3000 },
            [2] = { name = 'Phantom', payment = 3500 },
            [3] = { name = 'Revenant', isboss = true, payment = 4000 },
        },
    },
    ...
    ambulance = {
        ...
        offDutyPay = false,
        grades = {
            [0] = { name = 'Trainee', payment = 1350 },
            [1] = { name = 'Emergency Medical Technician', payment = 1575 },
            [2] = { name = 'Firefighter Paramedic', payment = 1625 },
            [3] = { name = 'Paramedic', payment = 1800 },
            [4] = { name = 'Senior Paramedic', payment = 2075 },
            [5] = { name = 'Nurse Practitioner', payment = 2250 },
            [6] = { name = 'Doctor', payment = 2700 },
            [7] = { name = 'Lieutenant', payment = 2875 },
            [8] = { name = 'Captain', payment = 3050 },
            [9] = { name = 'Deputy Chief Medical Officer', isboss = true, payment = 3250 },
            [10] = { name = 'Chief Medical Officer', isboss = true, payment = 3375 },
        },
    },
    ...
    unicorn = {
        ...
        grades = {
            [0] = { name = "Trainee", payment = 200 },
            [1] = { name = "Bartender", payment = 300 },
            [2] = { name = "Dancer", payment = 400 },
            [3] = { name = "Security", payment = 400 },
            [4] = { name = "Head Dancer", payment = 650 },
            [5] = { name = "Manager", isboss = true, payment = 800 },
