...
return {
	...
	trojan_usb                   = { name = 'trojan_usb', label = 'Trojan USB', weight = 0, type = 'item', image = 'usb_device.png', unique = true, useable = false, shouldClose = true, combinable = nil, description = 'Skimmer firmware on a stick. Limited data slots — use wisely.' },
